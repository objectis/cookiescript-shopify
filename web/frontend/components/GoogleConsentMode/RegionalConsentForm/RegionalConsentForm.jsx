              ...
              <div className="google-consent-mode__region">
                <div className="google-consent-mode__input-box">
                  <div className="google-consent-mode__inputs">
                    ...
                    <ErrorMessage className="error-message" name={`regional_consents[${index}].region`}
                                  component="div"/>
                  </div>
                ...
                <div className="google-consent-mode__input-box">
                  <ConsentField name={`regional_consents[${index}].functionality_storage`}
                  ...
                  <div className="google-consent-mode__inputs">
                    ...
                    <ErrorMessage className="error-message" name={`regional_consents[${index}].wait_for_update`}
                                  component="div"/>
                  </div>
                </div>
              </div>
